...
// Thu May  1 04:55:57 2014 by ROOT version 5.32/00
// from TTree tree/
// found on file: /eos/uscms/store/user/fgior8/Summer12_tag18/ttbar/file_9_1_zp6.root
//////////////////////////////////////////////////////////
...
class Data {
    ...
    vector<bool>    *ElectronHLTEMuMatched17;
    vector<bool>    *ElectronHLTEMuMatched8;
    vector<bool>    *ElectronHLTSingleEleMatched17;
    vector<bool>    *ElectronHLTSingleEleMatched8;
    ...
    vector<bool>    *MuonHLTDoubleMuonMatched;
    vector<bool>    *MuonHLTEMuMatched17;
    vector<bool>    *MuonHLTEMuMatched8;
    vector<bool>    *MuonHLTSingleIsoMuonMatched;
    vector<bool>    *MuonHLTSingleMuonMatched;
    vector<bool>    *MuonHLTSingleMuonMatched12;
    vector<bool>    *MuonHLTSingleMuonMatched17;
    vector<bool>    *MuonHLTSingleMuonMatched24;
    vector<bool>    *MuonHLTSingleMuonMatched5;
    vector<bool>    *MuonHLTSingleMuonMatched8;
    vector<bool>    *PFJetPileupjetIDpassLooseWP;
    vector<bool>    *PFJetPileupjetIDpassMediumWP;
    vector<bool>    *PFJetPileupjetIDpassTightWP;
    ...
    vector<double>  *ElectronmvaNontrigV0;
    vector<double>  *ElectronmvatrigV0;
    ...
    vector<double>  *HPSTauAgainstMuonLoose3Discr;
    ...
    vector<double>  *HPSTauAgainstMuonTight3Discr;
    ...
    vector<double>  *MuonCocktailTrkVtxDXY;
    vector<double>  *MuonCocktailTrkVtxDZ;
    ...
    vector<double>  *MuonGlobalE;
    vector<double>  *MuonGlobalEta;
    vector<double>  *MuonGlobalPhi;
    vector<double>  *MuonGlobalPt;
    vector<double>  *MuonHLTDoubleMuonMatchEta;
    vector<double>  *MuonHLTDoubleMuonMatchPhi;
    vector<double>  *MuonHLTDoubleMuonMatchPt;
    ...
    vector<double>  *MuonMuonSpecE;
    vector<double>  *MuonMuonSpecEta;
    vector<double>  *MuonMuonSpecPhi;
    vector<double>  *MuonMuonSpecPt;
    ...
    vector<double>  *PFJetJetPileupMVA;
    ...
    vector<double>  *PFJetL5BottomJEC;
    vector<double>  *PFJetL5CharmJEC;
    vector<double>  *PFJetL5GluonJEC;
    vector<double>  *PFJetL5UDSJEC;
    ...
    vector<double>  *PFJetScaledDownEnergy;
    vector<double>  *PFJetScaledDownPt;
    vector<double>  *PFJetScaledUpEnergy;
    vector<double>  *PFJetScaledUpPt;
    vector<double>  *PFJetSimpleSecondaryVertexHighEffBTag;
    vector<double>  *PFJetSimpleSecondaryVertexHighPurBTag;
    vector<double>  *PFJetSmearedDownEnergy;
    vector<double>  *PFJetSmearedDownPt;
    vector<double>  *PFJetSmearedUpEnergy;
    vector<double>  *PFJetSmearedUpPt;
    ...
    vector<double>  *PFMETPhiType01XYCorElectronEnDown;
    vector<double>  *PFMETType01XYCorElectronEnDown;
    vector<double>  *PFSumETType01XYCorElectronEnDown;
    vector<double>  *PFMETPhiType01XYCorElectronEnUp;
    vector<double>  *PFMETType01XYCorElectronEnUp;
    vector<double>  *PFSumETType01XYCorElectronEnUp;
    vector<double>  *PFMETPhiType01XYCorJetEnDown;
    vector<double>  *PFMETType01XYCorJetEnDown;
    vector<double>  *PFSumETType01XYCorJetEnDown;
    vector<double>  *PFMETPhiType01XYCorJetEnUp;
    vector<double>  *PFMETType01XYCorJetEnUp;
    vector<double>  *PFSumETType01XYCorJetEnUp;
    vector<double>  *PFMETPhiType01XYCorJetResDown;
    vector<double>  *PFMETType01XYCorJetResDown;
    vector<double>  *PFSumETType01XYCorJetResDown;
    vector<double>  *PFMETPhiType01XYCorJetResUp;
    vector<double>  *PFMETType01XYCorJetResUp;
    vector<double>  *PFSumETType01XYCorJetResUp;
    vector<double>  *PFMETPhiType01XYCorMuonEnDown;
    vector<double>  *PFMETType01XYCorMuonEnDown;
    vector<double>  *PFSumETType01XYCorMuonEnDown;
    vector<double>  *PFMETPhiType01XYCorMuonEnUp;
    vector<double>  *PFMETType01XYCorMuonEnUp;
    vector<double>  *PFSumETType01XYCorMuonEnUp;
    vector<double>  *PFMETPhiType01XYCorTauEnDown;
    vector<double>  *PFMETType01XYCorTauEnDown;
    vector<double>  *PFSumETType01XYCorTauEnDown;
    vector<double>  *PFMETPhiType01XYCorTauEnUp;
    vector<double>  *PFMETType01XYCorTauEnUp;
    vector<double>  *PFSumETType01XYCorTauEnUp;
    vector<double>  *PFMETPhiType01XYCorUnclusteredDown;
    vector<double>  *PFMETType01XYCorUnclusteredDown;
    vector<double>  *PFSumETType01XYCorUnclusteredDown;
    vector<double>  *PFMETPhiType01XYCorUnclusteredUp;
    vector<double>  *PFMETType01XYCorUnclusteredUp;
    vector<double>  *PFSumETType01XYCorUnclusteredUp;
    ...
    vector<int>     *MuonCocktailTrkVtxIndex;
    vector<int>     *MuonGlobalCharge;
    vector<int>     *MuonGlobalTrkValidHits;
    vector<int>     *MuonIsGlobal;
    vector<int>     *MuonIsPF;
    vector<int>     *MuonIsTracker;
    vector<int>     *MuonMuonSpecCharge;
    ...
    vector<int>     *PFJetJetPileupIdflag;
    ...
    TBranch        *b_HPSTauAgainstMuonLoose3Discr;   //!
    ...
    TBranch        *b_HPSTauAgainstMuonTight3Discr;   //!
    ...
    TBranch        *b_MuonHLTDoubleMuonMatchEta;   //!
    TBranch        *b_MuonHLTDoubleMuonMatchPhi;   //!
    TBranch        *b_MuonHLTDoubleMuonMatchPt;   //!
    ...
    TBranch        *b_PFMETPhiType01XYCorElectronEnDown;   //!
    TBranch        *b_PFMETType01XYCorElectronEnDown;   //!
    TBranch        *b_PFSumETType01XYCorElectronEnDown;   //!
    TBranch        *b_PFMETPhiType01XYCorElectronEnUp;   //!
    TBranch        *b_PFMETType01XYCorElectronEnUp;   //!
    TBranch        *b_PFSumETType01XYCorElectronEnUp;   //!
    TBranch        *b_PFMETPhiType01XYCorJetEnDown;   //!
    TBranch        *b_PFMETType01XYCorJetEnDown;   //!
    TBranch        *b_PFSumETType01XYCorJetEnDown;   //!
    TBranch        *b_PFMETPhiType01XYCorJetEnUp;   //!
    TBranch        *b_PFMETType01XYCorJetEnUp;   //!
    TBranch        *b_PFSumETType01XYCorJetEnUp;   //!
    TBranch        *b_PFMETPhiType01XYCorJetResDown;   //!
    TBranch        *b_PFMETType01XYCorJetResDown;   //!
    TBranch        *b_PFSumETType01XYCorJetResDown;   //!
    TBranch        *b_PFMETPhiType01XYCorJetResUp;   //!
    TBranch        *b_PFMETType01XYCorJetResUp;   //!
    TBranch        *b_PFSumETType01XYCorJetResUp;   //!
    TBranch        *b_PFMETPhiType01XYCorMuonEnDown;   //!
    TBranch        *b_PFMETType01XYCorMuonEnDown;   //!
    TBranch        *b_PFSumETType01XYCorMuonEnDown;   //!
    TBranch        *b_PFMETPhiType01XYCorMuonEnUp;   //!
    TBranch        *b_PFMETType01XYCorMuonEnUp;   //!
    TBranch        *b_PFSumETType01XYCorMuonEnUp;   //!
    TBranch        *b_PFMETPhiType01XYCorTauEnDown;   //!
    TBranch        *b_PFMETType01XYCorTauEnDown;   //!
    TBranch        *b_PFSumETType01XYCorTauEnDown;   //!
    TBranch        *b_PFMETPhiType01XYCorTauEnUp;   //!
    TBranch        *b_PFMETType01XYCorTauEnUp;   //!
    TBranch        *b_PFSumETType01XYCorTauEnUp;   //!
    TBranch        *b_PFMETPhiType01XYCorUnclusteredDown;   //!
    TBranch        *b_PFMETType01XYCorUnclusteredDown;   //!
    TBranch        *b_PFSumETType01XYCorUnclusteredDown;   //!
    TBranch        *b_PFMETPhiType01XYCorUnclusteredUp;   //!
    TBranch        *b_PFMETType01XYCorUnclusteredUp;   //!
    TBranch        *b_PFSumETType01XYCorUnclusteredUp;   //!
    ...
    TBranch        *b_MuonCocktailTrkVtxIndex;   //!
