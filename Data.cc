...
void Data::Init(TTree *tree)
{
    ...
    fChain->SetBranchAddress("HPSTauAgainstMuonLoose3Discr", &HPSTauAgainstMuonLoose3Discr, &b_HPSTauAgainstMuonLoose3Discr);
    ...
    fChain->SetBranchAddress("HPSTauAgainstMuonTight3Discr", &HPSTauAgainstMuonTight3Discr, &b_HPSTauAgainstMuonTight3Discr);
    ...
    fChain->SetBranchAddress("MuonCocktailTrkVtxDXY", &MuonCocktailTrkVtxDXY, &b_MuonCocktailTrkVtxDXY);
    fChain->SetBranchAddress("MuonCocktailTrkVtxDZ", &MuonCocktailTrkVtxDZ, &b_MuonCocktailTrkVtxDZ);
    ...
    fChain->SetBranchAddress("MuonGlobalE", &MuonGlobalE, &b_MuonGlobalE);
    fChain->SetBranchAddress("MuonGlobalEta", &MuonGlobalEta, &b_MuonGlobalEta);
    fChain->SetBranchAddress("MuonGlobalPhi", &MuonGlobalPhi, &b_MuonGlobalPhi);
    fChain->SetBranchAddress("MuonGlobalPt", &MuonGlobalPt, &b_MuonGlobalPt);
    fChain->SetBranchAddress("MuonHLTDoubleMuonMatchEta", &MuonHLTDoubleMuonMatchEta, &b_MuonHLTDoubleMuonMatchEta);
    fChain->SetBranchAddress("MuonHLTDoubleMuonMatchPhi", &MuonHLTDoubleMuonMatchPhi, &b_MuonHLTDoubleMuonMatchPhi);
    fChain->SetBranchAddress("MuonHLTDoubleMuonMatchPt", &MuonHLTDoubleMuonMatchPt, &b_MuonHLTDoubleMuonMatchPt);
    ...
    fChain->SetBranchAddress("MuonMuonSpecE", &MuonMuonSpecE, &b_MuonMuonSpecE);
    fChain->SetBranchAddress("MuonMuonSpecEta", &MuonMuonSpecEta, &b_MuonMuonSpecEta);
    fChain->SetBranchAddress("MuonMuonSpecPhi", &MuonMuonSpecPhi, &b_MuonMuonSpecPhi);
    fChain->SetBranchAddress("MuonMuonSpecPt", &MuonMuonSpecPt, &b_MuonMuonSpecPt);
    ...
    fChain->SetBranchAddress("PFJetJetPileupMVA", &PFJetJetPileupMVA, &b_PFJetJetPileupMVA);
    ...
    fChain->SetBranchAddress("PFJetL5BottomJEC", &PFJetL5BottomJEC, &b_PFJetL5BottomJEC);
    fChain->SetBranchAddress("PFJetL5CharmJEC", &PFJetL5CharmJEC, &b_PFJetL5CharmJEC);
    fChain->SetBranchAddress("PFJetL5GluonJEC", &PFJetL5GluonJEC, &b_PFJetL5GluonJEC);
    fChain->SetBranchAddress("PFJetL5UDSJEC", &PFJetL5UDSJEC, &b_PFJetL5UDSJEC);
    ...
    fChain->SetBranchAddress("PFJetScaledDownEnergy", &PFJetScaledDownEnergy, &b_PFJetScaledDownEnergy);
    fChain->SetBranchAddress("PFJetScaledDownPt", &PFJetScaledDownPt, &b_PFJetScaledDownPt);
    fChain->SetBranchAddress("PFJetScaledUpEnergy", &PFJetScaledUpEnergy, &b_PFJetScaledUpEnergy);
    fChain->SetBranchAddress("PFJetScaledUpPt", &PFJetScaledUpPt, &b_PFJetScaledUpPt);
    ...
    fChain->SetBranchAddress("PFJetSmearedDownEnergy", &PFJetSmearedDownEnergy, &b_PFJetSmearedDownEnergy);
    fChain->SetBranchAddress("PFJetSmearedDownPt", &PFJetSmearedDownPt, &b_PFJetSmearedDownPt);
    fChain->SetBranchAddress("PFJetSmearedUpEnergy", &PFJetSmearedUpEnergy, &b_PFJetSmearedUpEnergy);
    fChain->SetBranchAddress("PFJetSmearedUpPt", &PFJetSmearedUpPt, &b_PFJetSmearedUpPt);
    ...
    fChain->SetBranchAddress("PFMETPhiType01XYCorElectronEnDown", &PFMETPhiType01XYCorElectronEnDown, &b_PFMETPhiType01XYCorElectronEnDown);
    fChain->SetBranchAddress("PFMETType01XYCorElectronEnDown", &PFMETType01XYCorElectronEnDown, &b_PFMETType01XYCorElectronEnDown);
    fChain->SetBranchAddress("PFSumETType01XYCorElectronEnDown", &PFSumETType01XYCorElectronEnDown, &b_PFSumETType01XYCorElectronEnDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorElectronEnUp", &PFMETPhiType01XYCorElectronEnUp, &b_PFMETPhiType01XYCorElectronEnUp);
    fChain->SetBranchAddress("PFMETType01XYCorElectronEnUp", &PFMETType01XYCorElectronEnUp, &b_PFMETType01XYCorElectronEnUp);
    fChain->SetBranchAddress("PFSumETType01XYCorElectronEnUp", &PFSumETType01XYCorElectronEnUp, &b_PFSumETType01XYCorElectronEnUp);
    fChain->SetBranchAddress("PFMETPhiType01XYCorJetEnDown", &PFMETPhiType01XYCorJetEnDown, &b_PFMETPhiType01XYCorJetEnDown);
    fChain->SetBranchAddress("PFMETType01XYCorJetEnDown", &PFMETType01XYCorJetEnDown, &b_PFMETType01XYCorJetEnDown);
    fChain->SetBranchAddress("PFSumETType01XYCorJetEnDown", &PFSumETType01XYCorJetEnDown, &b_PFSumETType01XYCorJetEnDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorJetEnUp", &PFMETPhiType01XYCorJetEnUp, &b_PFMETPhiType01XYCorJetEnUp);
    fChain->SetBranchAddress("PFMETType01XYCorJetEnUp", &PFMETType01XYCorJetEnUp, &b_PFMETType01XYCorJetEnUp);
    fChain->SetBranchAddress("PFSumETType01XYCorJetEnUp", &PFSumETType01XYCorJetEnUp, &b_PFSumETType01XYCorJetEnUp);
    fChain->SetBranchAddress("PFMETPhiType01XYCorJetResDown", &PFMETPhiType01XYCorJetResDown, &b_PFMETPhiType01XYCorJetResDown);
    fChain->SetBranchAddress("PFMETType01XYCorJetResDown", &PFMETType01XYCorJetResDown, &b_PFMETType01XYCorJetResDown);
    fChain->SetBranchAddress("PFSumETType01XYCorJetResDown", &PFSumETType01XYCorJetResDown, &b_PFSumETType01XYCorJetResDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorJetResUp", &PFMETPhiType01XYCorJetResUp, &b_PFMETPhiType01XYCorJetResUp);
    fChain->SetBranchAddress("PFMETType01XYCorJetResUp", &PFMETType01XYCorJetResUp, &b_PFMETType01XYCorJetResUp);
    fChain->SetBranchAddress("PFSumETType01XYCorJetResUp", &PFSumETType01XYCorJetResUp, &b_PFSumETType01XYCorJetResUp);
    fChain->SetBranchAddress("PFMETPhiType01XYCorMuonEnDown", &PFMETPhiType01XYCorMuonEnDown, &b_PFMETPhiType01XYCorMuonEnDown);
    fChain->SetBranchAddress("PFMETType01XYCorMuonEnDown", &PFMETType01XYCorMuonEnDown, &b_PFMETType01XYCorMuonEnDown);
    fChain->SetBranchAddress("PFSumETType01XYCorMuonEnDown", &PFSumETType01XYCorMuonEnDown, &b_PFSumETType01XYCorMuonEnDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorMuonEnUp", &PFMETPhiType01XYCorMuonEnUp, &b_PFMETPhiType01XYCorMuonEnUp);
    fChain->SetBranchAddress("PFMETType01XYCorMuonEnUp", &PFMETType01XYCorMuonEnUp, &b_PFMETType01XYCorMuonEnUp);
    fChain->SetBranchAddress("PFSumETType01XYCorMuonEnUp", &PFSumETType01XYCorMuonEnUp, &b_PFSumETType01XYCorMuonEnUp);
    fChain->SetBranchAddress("PFMETPhiType01XYCorTauEnDown", &PFMETPhiType01XYCorTauEnDown, &b_PFMETPhiType01XYCorTauEnDown);
    fChain->SetBranchAddress("PFMETType01XYCorTauEnDown", &PFMETType01XYCorTauEnDown, &b_PFMETType01XYCorTauEnDown);
    fChain->SetBranchAddress("PFSumETType01XYCorTauEnDown", &PFSumETType01XYCorTauEnDown, &b_PFSumETType01XYCorTauEnDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorTauEnUp", &PFMETPhiType01XYCorTauEnUp, &b_PFMETPhiType01XYCorTauEnUp);
    fChain->SetBranchAddress("PFMETType01XYCorTauEnUp", &PFMETType01XYCorTauEnUp, &b_PFMETType01XYCorTauEnUp);
    fChain->SetBranchAddress("PFSumETType01XYCorTauEnUp", &PFSumETType01XYCorTauEnUp, &b_PFSumETType01XYCorTauEnUp);
    fChain->SetBranchAddress("PFMETPhiType01XYCorUnclusteredDown", &PFMETPhiType01XYCorUnclusteredDown, &b_PFMETPhiType01XYCorUnclusteredDown);
    fChain->SetBranchAddress("PFMETType01XYCorUnclusteredDown", &PFMETType01XYCorUnclusteredDown, &b_PFMETType01XYCorUnclusteredDown);
    fChain->SetBranchAddress("PFSumETType01XYCorUnclusteredDown", &PFSumETType01XYCorUnclusteredDown, &b_PFSumETType01XYCorUnclusteredDown);
    fChain->SetBranchAddress("PFMETPhiType01XYCorUnclusteredUp", &PFMETPhiType01XYCorUnclusteredUp, &b_PFMETPhiType01XYCorUnclusteredUp);
    fChain->SetBranchAddress("PFMETType01XYCorUnclusteredUp", &PFMETType01XYCorUnclusteredUp, &b_PFMETType01XYCorUnclusteredUp);
    fChain->SetBranchAddress("PFSumETType01XYCorUnclusteredUp", &PFSumETType01XYCorUnclusteredUp, &b_PFSumETType01XYCorUnclusteredUp);
    ...
    fChain->SetBranchAddress("MuonCocktailTrkVtxIndex", &MuonCocktailTrkVtxIndex, &b_MuonCocktailTrkVtxIndex);
    fChain->SetBranchAddress("MuonGlobalCharge", &MuonGlobalCharge, &b_MuonGlobalCharge);
    ...
    fChain->SetBranchAddress("MuonMuonSpecCharge", &MuonMuonSpecCharge, &b_MuonMuonSpecCharge);
    ...
    fChain->SetBranchAddress("MuonTrackerCharge", &MuonTrackerCharge, &b_MuonTrackerCharge);
    ...
    fChain->SetBranchAddress("PFJetJetPileupIdflag", &PFJetJetPileupIdflag, &b_PFJetJetPileupIdflag);
