...

{
  ...
  if ("$dataset" == "QCD_mu15") {
    ...
    Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("QCD_mu15_v3_job$num",90); 
  ...
  if ("$dataset" == "QCD_20-30") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_20-30_EM_job$num",60);
  ...
  if ("$dataset" == "QCD_30-80") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_30-80_EM_job$num",60);
  ...
  if ("$dataset" == "QCD_80-170") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_80-170_EM_job$num",60);
  ...
  if ("$dataset" == "QCD_170-250") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_170-250_EM_job$num",60);
  ...
  if ("$dataset" == "QCD_250-350") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_250-350_EM_job$num",60);
  ...
  if ("$dataset" == "QCD_350_EM") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("QCD_350_EM_job$num",60);
  ...
  if ("$dataset" == "Wgamma") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator Pippo; Pippo.Init(chain); Pippo.SetName("Wgamma_job$num",76);
  ...
  if (0) {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
    FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("Wgamma_job$num",60);
    Pippo.SetWeight(461.6, 4802358);
    std::cout << "Wgamma\n";  Pippo.LoopFR();
  }
  ...
  if ("$dataset" == "ttbar") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("ttbar_job$num",76); 
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("ttbar_job$num",60); 
     Pippo.SetWeight(234., 6736135);
     std::cout << "ttbar\n";  Pippo.LoopFR();
  }
  ...
  if ("$dataset" == "W_jets") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("Wjets_job$num",76);
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("Wjets_job$num",60);
     Pippo.SetWeight(37509.0, 57709905);
     std::cout << "Wjets\n";  Pippo.LoopFR();
  }
  ...
  if ("$dataset" == "ttZ") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("ttZ_job$num",76); 
  ...
  if ("$dataset" == "ttW") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("ttW_job$num",76); 
  ...
  if ("$dataset" == "ttWW") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("ttWW_job$num",76); 
  ...
  if ("$dataset" == "WW") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WW_job$num",76); 
  ...
  if ("$dataset" == "WpWp") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WpWp_job$num",76); 
  ...
  if ("$dataset" == "WmWm") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WmWm_job$num",76); 
  ...
  if ("$dataset" == "WWW") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WWW_job$num",76); 
  ...
  if ("$dataset" == "ZZZ") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("ZZZ_job$num",76); 
  ...
  if ("$dataset" == "WWZ") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WWZ_job$num",76); 
  ...
  if ("$dataset" == "WZZ") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("WZZ_job$num",76); 
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("DY_10-50_job$num",60); 
     Pippo.SetWeight(11050., 37835275);
     std::cout << "DY\n";  Pippo.LoopFR();
  }
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("DY_50_job$num",60); 
     Pippo.SetWeight(3503.71, 30459503);
     std::cout << "DY\n";  Pippo.LoopFR();
  }
  ...
  if ("$dataset" == "SingleMu") {
     TChain* chain = ChainMaker("$dir/$list");
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("SingleMu_job$num",51);
     std::cout << "mu\n";  Pippo.Loop();
  }

  if ("$dataset" == "SingleElectron") {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     FRCalculator_Ele Pippo; Pippo.Init(chain); Pippo.SetName("SingleElectron_job$num",60);
     std::cout << "Ele\n";  Pippo.LoopFR();
  }

  if ("$dataset" == "DoubleMu" || "$dataset" == "OnlySingleMu") {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     Analyzer Pippo; Pippo.Init(chain); Pippo.SetName("DoubleMu_job$num",61);
     std::cout << "mu\n";  Pippo.Loop();
  }
