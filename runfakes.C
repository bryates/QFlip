{
  ...
  gROOT->ProcessLine(".L AnalyzerFR.cc+g");
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("QCD_mumu_40",130); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttbar_closure",100); 
     //Pippo.SetWeight(154.0, 3701947);
     std::cout << "ttbar\n";  Pippo.Loop();
  }
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("QCD_1000_mu_del",8); //Pippo.SetWeight(154.0, 3701947);
     std::cout << "QCD_mu\n";  Pippo.Loop();
  }

  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/DataSetList/N_40.txt");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana40_syn",114);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana50",114); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana60",114);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana70",114); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana80_sync",115);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana90",115); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana100",115); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana125",115);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana150",115);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana175",115);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana200_sync",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana250",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana300_syn",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana350",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana400",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana500",117); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana600_syn",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Majorana700_sync",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ZZ_inclusive_WZctrl",130); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WZ_inclusive_WZctrl",130); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WpWp",117); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WmWm",117); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WW_dp",114); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WWW",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WWZ",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WZZ",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ZZZ",117);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WWG",101);
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttW",117); 
  ...
  if (0) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttWW",117);
  ...
  if (1) {
     ...
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttZ",117); 
  ...
  if (0) {
     ...
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DoubleMu_prova",1); //Pippo.SetWeight(.02);
     std::cout << "mu\n";  Pippo.Loop();
  }
