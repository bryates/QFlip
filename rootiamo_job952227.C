
{
  ...
  if ("ttW" == "QCD_mu15") {
    TChain* chain = ChainMaker("/uscms_data/d3/byates/CMSSW_5_3_14_patch2/src/muon/little0ttW.txt");
  ...
  if ("ttW" == "QCD_15-20_mu") {
    TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/little0ttW.txt");
