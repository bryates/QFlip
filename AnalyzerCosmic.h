#ifndef AnalyzerCosmic_h
#define AnalyzerCosmic_h
...
class AnalyzerCosmic : public Data {
...
//  static const Double_t integratedlumi = 1.0; //for Fakes
 ...
 public:
  ...
  Fakes *h_ChargeFlip, *h_ChargeFlipCuts, *h_TagFlip;
  Fakes *h_DYFlip, *h_DYFlipCut, *h_DYFlipTag;
  Fakes *h_NoJets_Flip_SS, *h_NoJets_Flip_OS;
