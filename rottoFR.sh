...

{
  ...
  gROOT->ProcessLine(".L AnalyzerFR_cc.so");
  ...
  if ("$dataset" == "QCD_mu15") {
    ...
    AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("QCD_mu15_v3_FR40_job$num",90); 
  ...
  if ("$dataset" == "ttbar") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttbar_FR40_job$num",76); 
  ...
  if ("$dataset" == "W_jets") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("Wjets_FR40_job$num",76);
  ...
  if ("$dataset" == "DY_10-50") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DY_10-50_FR40_job$num",76); 
  ...
  if ("$dataset" == "DY_50") {
     TChain* chain = ChainMaker("$dir/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DY_50_FR40_job$num",76); 
  ...
  if ("$dataset" == "QCD_mumu") {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("QCD_mumu_job$num",31); 
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DY_10-50_job$num",76); 
     Pippo.SetWeight(11050., 37835275);
     std::cout << "DY\n";  Pippo.Loop();
  }
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     // 1076311113.674 (mb)^-1 
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DY_50_job$num",76); 
     Pippo.SetWeight(3503.71, 30459503);
     std::cout << "DY\n";  Pippo.Loop();
  }
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ttbar_job$num",90); 
     //Pippo.SetWeight(234., 6736135);
     std::cout << "ttbar\n";  Pippo.Loop();
  }
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WgammaStar_job$num",31); 
  ...
  if ("$dataset" == "QCD_X_mu") {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("QCD_X_mu_job$num",90); 
     //Pippo.SetWeight(10.04, 2194752);
     std::cout << "QCD_X_mu\n";  Pippo.Loop();
  }
  ...
  if (0) {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("W_jets_job$num",90); 
     //Pippo.SetWeight(37509.0, 57709905);
     std::cout << "W_jets\n";  Pippo.Loop();
  }
  ...
  if ("$dataset" == "ZZ_inclusive") {
     TChain* chain = ChainMaker("$dir/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("ZZ_inclusive_FR40_job$num",71); 
  ...
  if ("$dataset" == "WZ_inclusive") {
     TChain* chain = ChainMaker("$dir/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WZ_inclusive_FR40_job$num",71); 
  ...
  if ("$dataset" == "WW_inclusive") {
     TChain* chain = ChainMaker("$dir/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("WW_inclusive_FR40_job$num",71);
  ...
  if ("$dataset" == "SingleMu") {
     TChain* chain = ChainMaker("$dir/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("SingleMu_FR40_job$num",51);
     std::cout << "mu\n";  Pippo.Loop();
  }
  ...
  if ("$dataset" == "DoubleMu" || "$dataset" == "OnlySingleMu") {
     TChain* chain = ChainMaker("/uscms_data/d2/fgior8/LQntuple_18/CMSSW_5_3_14_patch2_LQ/src/code/$list");
     AnalyzerFR Pippo; Pippo.Init(chain); Pippo.SetName("DoubleMu_FR40_job$num",61);
     std::cout << "mu\n";  Pippo.Loop();
  }
